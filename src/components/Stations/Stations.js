...
class Stations extends Component {
  ...
  handleMoveStart = () => {
    if (
      this.props.location.pathname === "/bottomsheet" ||
  ...
  showCenter = () => {
    this.centerTimeout = window.setTimeout(() => {
      this.props.history.push({
        pathname:
          "/station/" +
          this.props.center.station.properties.provider +
          "/" +
          this.props.center.station.properties.id +
          "/center",
        state: {
          x: "50%",
          y: "50%",
  ...
  render() {
    ...
    clusterBoard = (
      <div className="air__site air__site--favboard air__site--cluster">
        <Dashboard
