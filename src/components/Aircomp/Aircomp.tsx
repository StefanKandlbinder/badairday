...
export default function Aircomp({ component, value, unit }: Props) {
  switch (component) {
    case 'NO2':
    case 'PM10':
    case 'PM25': {
      ...
      return (
        <div className={`air__comp air__comp--dust air__comp--dust-${component}`}>
          <div className="air__comp-title">{component}:</div>
          <div className="air__comp-value">
            {value === 0 ? '-' : value}<span className="air__comp-unit">&nbsp;{unit}</span>
          </div>
        </div>
      );
    }
    ...
    case 'WIR': {
      const dir = value || 0;
      return (
        <div className="air__comp-wind-direction" style={{ transform: `rotate(${dir - 180}deg)` }}>
          <svg className="air__comp-wind-direction-svg" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 600 600">
    ...
    case 'WIV': {
      ...
      return (
        <div className="air__comp-wind-force">
          <div className="air__comp-value">{force.toFixed(1)}</div>
    ...
    case 'TEMP':
      return (
        <div className="air__comp air__comp--temp">
          <svg className="air__comp-temp-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250.189 250.189">
            <g>
          ...
          <div>
            <div className="air__comp-value">{(value || 0).toFixed(1)}°</div>
