    ...
    return (
        <div style={{ height: "0", visibility: "hidden" }}>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <symbol width="24" height="24" viewBox="0 0 24 24" id="airSVGLogoCoolSimple">
                    <path className="air__color-primary" d="M12 23.5C5.6 23.5.5 18.4.5 12S5.6.5 12 .5 23.5 5.6 23.5 12 18.4 23.5 12 23.5z"/>
                    <path className="air__color-text" d="M12 .9c6.1 0 11.1 5 11.1 11.1s-5 11.1-11.1 11.1S.9 18.1.9 12 5.9.9 12 .9m0-.9C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0z"/>
                    <path className="air__color-text" d="M17.5 6.1c.1 0 .2 0 .3.1.1.1.1.2.1.4l-4.4 13.1c-.1.2-.2.3-.4.3-.1 0-.2 0-.3-.1 0 0-.1-.1-.1-.2l-2.1-6.2c0-.1-.1-.1-.1-.2 0 0-.1-.1-.2-.1l-6.2-2.1c-.1 0-.1-.1-.2-.1.1-.1.1-.5.4-.5l13.1-4.4h.1m0-1.1c-.2 0-.3 0-.5.1L4 9.4c-.5.2-.8.6-1 1-.1.5 0 1 .4 1.4.2.2.4.3.6.4l5.8 1.9 1.9 5.8c.1.2.2.4.4.6.3.3.6.4 1 .4.6 0 1.2-.4 1.4-1l4.4-13.1c.2-.5 0-1.1-.4-1.5-.2-.1-.6-.3-1-.3z"/>
                    <path className="air__color-text" d="M15.6 8.4l-4 4c-.1.1-.3.1-.4.1l-4-1.3c-.1 0-.1-.1-.2-.1-.2-.2-.1-.5.2-.6l8-2.7c.2-.1.3 0 .4.1.1.1.2.3 0 .5z"/>
                </symbol>
