    ...
    return (
        <div style={{ height: "0", visibility: "hidden" }}>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <symbol width="24" height="24" viewBox="0 0 24 24" id="airGasMask">
                ...
                <symbol width="24" height="24" viewBox="0 0 24 24" id="airSVGChevronLeft">
                    <path fill="none" d="M0 0h24v24H0V0z"/>
                    <path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12l4.58-4.59z"/>
                </symbol>

                <symbol width="24" height="24" viewBox="0 0 24 24" id="airSVGClose">
                    <path fill="none" d="M0 0h24v24H0V0z"/>
